...
export default function IngredientQuantityComponent({ item, selected, setSelected, total }) {
  ...
  return (
    ...
    >
      <IconButton icon="information" size={24} className="m-0 p-0" color={themeColors.bgWhite(0.7)} />
      ...
      <View className="flex-1">
        ...
        >
          ...
          >
            <Text className="text-gray-200 font-semibold text-xl -mt-0.5">{"/ " + total}</Text>
          </Pressable>
        </View>
      </View>
    </Animated.View>
