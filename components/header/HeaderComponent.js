...
export default function HeaderComponent({ text, canGoBack }) {
  ...
  function SvgComponent() {
    if (!canGoBack)
      return (
        <Svg width={74} height={74} viewBox="0 0 1024 1024" fill="none">
    ...
    return (
      <Svg width={74} height={74} viewBox="0 0 1024 1024" fill="none">
        <G clipPath="url(#clip0_1_228)">
          ...
          <Path
            d="M470.735 629v-84.4h188.631l.634-42.411H470.735V418L365 523.5 470.735 629z"
            fill="#000"
          />
        </G>
        <Defs>
  ...
  return (
    ...
    >
      <View className="flex-row items-center space-x-3">
        ...
        <Text
          className="font-semibold text-2xl pl-1"
